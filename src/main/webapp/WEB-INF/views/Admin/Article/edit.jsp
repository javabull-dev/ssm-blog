...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="editSubmitForm" action="/admin/article/editSubmit">
        <div class="layui-form-item">
            <label class="layui-form-label">图片 <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img" src="${article.articleImageUrl}" id="demo1"
                             height="100">
                        <p id="demoText"></p>
                    </div>
            ...
            <input type="hidden" name="articleImageUrl" id="articleImageUrl" value="">
        </div>
        <input type="hidden" name="articleId" value="${article.articleId}">
        <div class="layui-form-item">
            <label class="layui-form-label">标题 <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-block">
                <input type="hidden" name="copyArticleTitle" value="${article.articleTitle}">
                ...
                <select name="articleParentCategoryId" id="articleParentCategoryId"
                    ...
                    <c:forEach items="${categories}" var="c">
                        <option value="${c.categoryId}"
                                <c:if test="${article.categories[0].categoryId == c.categoryId}">
                                    selected
                                </c:if>
        ...
        <div class="layui-form-item" pane="">
            ...
            <div class="layui-input-block">
                <c:forEach items="${tags}" var="t">
                    <input type="checkbox" name="articleTagIds" lay-skin="primary" title="${t.tagContent}"
                           value="${t.tagId}"
                    <c:forEach items="${article.tags}" var="t2">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="demo1" id="update-submit">保存</button>
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                before: function (obj) {
                    ...
                    $("#articleImageUrl").attr("value", result.extend.fileUrl);
                    if (result.code != 100) {
