...
<rapid:override name="content">
    ...
    <form class="layui-form" action="/admin/user/insertSubmit" id="userForm"
        ...
        <div class="layui-form-item">
            ...
            <input type="hidden" name="userAvatarUrl" id="userAvatarUrl" value="">
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="userPassword"  id="userPass" required
                       lay-verify="userPass"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="url" name="userUrl" id="userUrl" placeholder="" class="layui-input" onblur="checkUrl(0)">
            </div>
            <div class="layui-form-mid layui-word-aux" id="userUrlTips"></div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label">状态</label>
            <div class="layui-input-block">
                <input type="radio" name="userStatus" value="1" title="正常" checked="checked">
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                before: function (obj) {
                    ...
                    $("#userAvatarUrl").attr("value", result.extend.fileUrl);
                    if (result.code != 100) {
