...
<%--            <li>小工具</li>--%>
        ...
        <div class="layui-tab-content">
            <br><br>
            <c:choose>
                <c:when test="${options.optionId>0}">
            ...
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="optionTitle"  value="${options.optionTitle}"   autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="optionPageDescrption"  value="${options.optionPageDescrption}"   autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
