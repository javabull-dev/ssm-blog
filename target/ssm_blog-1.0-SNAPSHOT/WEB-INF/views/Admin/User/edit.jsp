...
<rapid:override name="content">
    ...
    <form class="layui-form" id="userForm"
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img" src="${user.userAvatarUrl}" id="demo1" width="100"
                             height="100">
                        <p id="demoText"></p>
                    </div>
                    <button type="button" class="layui-btn" id="test1">上传图片</button>
                    <input type="hidden" name="userAvatarUrl" id="userAvatar" value="${user.userAvatarUrl}">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="hidden" value="${user.userName}" name="copyUserName">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="userPassword" value="${user.userPassword}" id="userPass" required
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                before: function (obj) {
                    ...
                    $("#userAvatar").attr("value", result.extend.fileUrl);
                    if (result.code != 100) {
