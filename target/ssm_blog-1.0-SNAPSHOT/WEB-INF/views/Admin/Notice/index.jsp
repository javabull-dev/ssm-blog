            ...
            <table class="layui-table" >
                ...
                <c:forEach items="${notices}" var="c">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/admin/notice/edit/${c.noticeId}" class="layui-btn layui-btn-xs">编辑</a>
                            <a href="/admin/notice/delete/${c.noticeId}" class="layui-btn layui-btn-danger layui-btn-xs" onclick="return confirmDelete()">删除</a>
                        </td>
                        <td >${c.noticeId}</td>
                    </tr>
